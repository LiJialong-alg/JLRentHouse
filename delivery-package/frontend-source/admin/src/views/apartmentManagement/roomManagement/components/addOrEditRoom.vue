<template>
  <el-card>
    ...
    <el-form ref="apartmentFormRef" :model="formData" :rules="rules" label-width="120px" style="max-width: 660px"
      status-icon>
      ...
      <el-form-item label="所属公寓" required>
        <div class="flex-center">
          ...
          <el-form-item prop="apartmentId">
            <el-select v-model="areaInfo.apartmentId" placeholder="请选择公寓" clearable @change="apartmentChangeCallback"
      ...
      <el-form-item label="房间属性" prop="attrValueIds">
        <el-tree-select style="width: 100%" v-model="formData.attrValueIds" placeholder="请选择房间属性" :data="attrInfoList"
          multiple clearable node-key="value" :render-after-expand="false"
          @node-click="attrNodeClickHandle"></el-tree-select>
      </el-form-item>
      <el-form-item label="房间配套" prop="facilityInfoIds">
        <el-select style="width: 100%" v-model="formData.facilityInfoIds" placeholder="请选择房间配套" multiple clearable>
          <el-option v-for="item in facilityInfoList" :key="item.id" :label="item.name" :value="item.id"></el-option>
        </el-select>
      </el-form-item>
      <el-form-item label="房间标签" prop="labelIds">
        <el-select style="width: 100%" v-model="formData.labelInfoIds" placeholder="请选择房间标签" multiple clearable>
          <el-option v-for="item in labelInfoList" :key="item.id" :label="item.name" :value="item.id"></el-option>
        </el-select>
      </el-form-item>
      <el-form-item label="支付方式" prop="paymentTypeIds">
        <el-select style="width: 100%" v-model="formData.paymentTypeIds" placeholder="请选择支付方式" multiple clearable>
      ...
      <el-form-item label="可选租期" prop="leaseTermIds">
        <el-select style="width: 100%" v-model="formData.leaseTermIds" placeholder="请选择可选租期" multiple clearable>
      ...
      <el-form-item label="图片" prop="graphVoList">
        <upload-img v-model:file-list="formData.graphVoList" :on-success="uploadSuccessHandle" list-type="picture-card"
          :limit="5"></upload-img>
      </el-form-item>
    </el-form>
